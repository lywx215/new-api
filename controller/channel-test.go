...
func testChannelForHealthCheck(ctx context.Context, channel *model.Channel, testUserID int, allowDisable bool, disableThreshold int64, processors ...func(*gin.Context, types.ChannelError, *types.NewAPIError)) channelTestSummary {
	...
	if allowDisable && isChannelEnabled && shouldBanChannel && channel.GetAutoBan() {
		...
		if len(processors) > 0 {
			processors[0](result.context, channelError, newAPIError)
		} else {
