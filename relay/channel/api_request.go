...
func DoApiRequest(a Adaptor, c *gin.Context, info *common.RelayInfo, requestBody io.Reader) (*http.Response, error) {
	...
	if info == nil || info.ChannelType != rootconstant.ChannelTypeNewAPI {
		req.Header.Del(common2.InternalAffinityHeader)
	}
...
func DoWssRequest(a Adaptor, c *gin.Context, info *common.RelayInfo, requestBody io.Reader) (*websocket.Conn, error) {
	...
	if info == nil || info.ChannelType != rootconstant.ChannelTypeNewAPI {
		targetHeader.Del(common2.InternalAffinityHeader)
	}
...
func doRequest(c *gin.Context, req *http.Request, info *common.RelayInfo) (*http.Response, error) {
	...
	service.ObserveOpenCodeGoUpstreamResponse(info.ChannelType, info.ChannelId, resp, time.Now())
