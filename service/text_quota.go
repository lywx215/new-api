...
func PostTextConsumeQuota(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, usage *dto.Usage, extraContent []string) {
	...
	if usage != nil && strings.HasPrefix(usage.UsageSource, "opencodego:") {
		...
		other.SetPublic("uncached_input_tokens", uncachedInputTokens)
		other.SetPublic("cache_read_tokens", logUsage.PromptTokensDetails.CachedTokens)
		...
		other.SetPublic("cache_write_5m_tokens", cacheWrite5mTokens)
		other.SetPublic("cache_write_1h_tokens", logUsage.ClaudeCacheCreation1hTokens)
		other.SetPublic("output_tokens", logUsage.CompletionTokens)
		other.SetPublic("reasoning_tokens", logUsage.CompletionTokenDetails.ReasoningTokens)
		other.SetPublic("usage_source", usage.UsageSource)
		if usage.Cost != nil {
			other.SetPublic("upstream_cost", usage.Cost)
		}
	}
